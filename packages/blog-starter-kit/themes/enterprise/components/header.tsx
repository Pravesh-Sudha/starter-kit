...
export const Header = () => {
  ...
  const navList = (
    <ul className="flex flex-row items-center gap-2 text-gray-700">
      {visibleItems.map((item) => (
        <li key={item.url}>
          <a
            ...
            className="transition-200 block max-w-[200px] truncate text-ellipsis whitespace-nowrap rounded-md p-2 transition-colors hover:bg-black/5 hover:text-black dark:hover:bg-neutral-800 dark:hover:text-white"
          >
            {item.label}
          </a>
        </li>
        ...
        <div className="col-span-2 flex flex-1 flex-row items-center gap-2 lg:col-span-1">
          <div className="lg:hidden">
            <Button
              ...
              className="rounded-xl border !px-3 !py-2 hover:bg-black/5 dark:hover:bg-neutral-800"
