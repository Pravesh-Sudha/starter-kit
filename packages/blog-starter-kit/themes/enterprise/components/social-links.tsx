...
import { GithubSVG, HashnodeSVG, LinkedinSVG, RssSVG, XSVG, InstagramSVG, GlobeSVG, YouTubeSVG } from './icons';
      ...
      >
        {hasSocialLinks && (
          <>
            ...
            <a
              href="https://www.instagram.com/sudha.pravesh/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Find us on my website, external website, opens in new tab"
              className="flex flex-row items-center justify-center rounded-full border border-slate-200 p-2 hover:bg-slate-100 dark:border-neutral-800 dark:hover:bg-neutral-600"
            >
              <GlobeSVG className="h-5 w-5 stroke-current" />
            </a>
            <a
              href="https://www.youtube.com/@pravesh-sudha"
              target="_blank"
              rel="noopener noreferrer"
